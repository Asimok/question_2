...
data = pd.read_excel('/home/asimov/PycharmProjects/question_2/question2/数据清洗/附件3.xlsx')
...
user_df_end.to_excel('/home/asimov/PycharmProjects/question_2/question2/数据清洗/去除30天内同一用户相似度0.75+的留言.xls', index=None)
